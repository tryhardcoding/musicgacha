...
import './gacha.js?v=20260327c'; // ガチャモジュール（グローバル参照にopenPackを登録）
...
import { initAds, showRewardedAd, updateAdButton, refreshModalBannerAd } from './ads.js?v=20260327c';
import { icon, refreshIcons } from './icons.js';
import { sharePackResult, shareCollectionStats } from './share-sns.js?v=20260327c';
