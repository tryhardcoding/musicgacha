...
// 繧｢繝励Μ蛻晄悄蛹悶・逕ｻ髱｢繝ｫ繝ｼ繝・ぅ繝ｳ繧ｰ繝ｻUI繧､繝吶Φ繝育ｮ｡逅・
// ============================================================
...
function showScreen(screenId) {
    ...
    // 繝代ャ繧ｯ逕ｻ髱｢縺九ｉ髮｢繧後◆繧芽ｩｦ閨ｴ髻ｳ螢ｰ繧貞●豁｢・・幕蟆√そ繝・す繝ｧ繝ｳ繧偵く繝｣繝ｳ繧ｻ繝ｫ
    if (screenId !== 'pack') {
...
async function updateTop200ChallengeCard() {
    ...
    // 繧ｳ繝ｬ繧ｯ繧ｷ繝ｧ繝ｳ逕ｻ髱｢(collection.js)縺ｨ蜷後§繝ｭ繧ｸ繝・け: obtainedKeys AND 繧ｳ繝ｬ繧ｯ繧ｷ繝ｧ繝ｳ蜀・↓繧ｫ繝ｼ繝峨′蟄伜惠
    ...
    // 繧ｳ繝ｬ繧ｯ繧ｷ繝ｧ繝ｳ蜀・・繧ｫ繝ｼ繝峨ｒ繧ｭ繝ｼ縺ｧ繝ｫ繝・け繧｢繝・・
...
async function updateTop200Progress() {
    ...
    // 莉頑律縺ｮ繝√Ε繝ｼ繝医・200譖ｲ繧貞叙蠕・
    const chartTracks = await getTop200Tracks();
    const total = chartTracks.length || 200;

    // 莉頑律縺ｮ繝√Ε繝ｼ繝医・譖ｲ繧ｭ繝ｼ縺ｨobtainedKeys縺ｮ荳閾ｴ謨ｰ繧偵き繧ｦ繝ｳ繝・
    // 繧ｳ繝ｬ繧ｯ繧ｷ繝ｧ繝ｳ逕ｻ髱｢縺ｨ蜷後§繝ｭ繧ｸ繝・け: obtainedKeys AND 繧ｳ繝ｬ繧ｯ繧ｷ繝ｧ繝ｳ蜀・↓繧ｫ繝ｼ繝峨′蟄伜惠
    const top200Data = getTop200Data();
    const obtainedSet = new Set(top200Data.obtainedKeys);
    const collection = getCollection();
    const collectionKeySet = new Set();
...
function setupEventListeners() {
    ...
    // TOP200繝√Ε繝ｬ繝ｳ繧ｸ繧ｫ繝ｼ繝・繧ｯ繝ｪ繝・け・医・繝ｼ繝 + 繝代ャ繧ｯ邨先棡・・
    ...
    // 繝ｪ繝ｼ繧ｸ繝ｧ繝ｳ蛻・崛繝懊ち繝ｳ・医ラ繝ｭ繝・・繝繧ｦ繝ｳ驕ｸ謚槫ｼ擾ｼ・
    ...
    // 繝代ャ繧ｯ繧ｫ繝ｫ繝ｼ繧ｻ繝ｫ - 繧ｯ繝ｪ繝・け縺ｧ逶ｴ謗･髢句ｰ・+ 繝峨Λ繝・げ繧ｹ繧ｯ繝ｭ繝ｼ繝ｫ
    ...
    if (carousel && track) {
        ...
        track.addEventListener('click', async (e) => {
            if (hasDragged) return; // 繝峨Λ繝・げ蠕後・繧ｯ繝ｪ繝・け辟｡蜉ｹ
    ...
    if (volumeSlider) {
        ...
        // 蛻晏屓繧｢繧ｯ繧ｻ繧ｹ譎ゅ・蜊ｳ蠎ｧ縺ｫlocalStorage縺ｫ菫晏ｭ假ｼ磯浹縺碁ｳｴ繧九ｈ縺・↓縺吶ｋ・・
    ...
    if (volumeBtn) {
        volumeBtn.addEventListener('click', () => {
            ...
            updateVolumeIcon(vol);
            // iOS蟇ｾ蠢・ audio.muted繧剃ｽｿ逕ｨ・・udio.volume縺ｯiOS縺ｧ辟｡蜉ｹ・・
            if (window.MusicGacha?.setPreviewMuted) {
    ...
    // Esc繧ｭ繝ｼ縺ｧ繝｢繝ｼ繝繝ｫ繧帝哩縺倥ｋ・・C繝ｦ繝ｼ繧ｶ繝ｼ蜷代￠UX謾ｹ蝟・ｼ・
...
function updateRegionDisplay() {
    ...
    if (countryBtn) {
        ...
        // 蛻晄悄髱櫁｡ｨ遉ｺ縺九ｉ縺ｮ蠕ｩ蟶ｰ・亥嵜譌励ヵ繝ｩ繝・す繝･髦ｲ豁｢・・
        countryBtn.style.visibility = '';
    }
}

/** 繝ｪ繝ｼ繧ｸ繝ｧ繝ｳ驕ｸ謚槭ラ繝ｭ繝・・繝繧ｦ繝ｳ繧定｡ｨ遉ｺ/髱櫁｡ｨ遉ｺ */
...
async function buildPackCarousel() {
    ...
    // 繝・・繧ｿ蜿門ｾ励ｒ蜈医↓陦後＞縲．OM譖ｴ譁ｰ縺ｯ譛蠕後↓荳諡ｬ縺ｧ螳溯｡鯉ｼ・LS髦ｲ豁｢・・
    ...
    // 荳諡ｬswap: 繧ｯ繝ｪ繧｢縺ｨ霑ｽ蜉繧帝｣邯壼ｮ溯｡後＠縲・蝗槭・reflow縺ｧ螳御ｺ・
    track.innerHTML = '';
    track.appendChild(fragment);

    // F5繝ｪ繝ｭ繝ｼ繝画凾縺ｫ繝悶Λ繧ｦ繧ｶ縺後せ繧ｯ繝ｭ繝ｼ繝ｫ菴咲ｽｮ繧貞ｾｩ蜈・＠縺ｦTOP200縺檎ｫｯ縺ｫ譚･繧九・繧帝亟豁｢
    track.scrollLeft = 0;
...
async function init() {
    // 繝悶Λ繧ｦ繧ｶ縺ｮ閾ｪ蜍輔せ繧ｯ繝ｭ繝ｼ繝ｫ蠕ｩ蜈・ｒ辟｡蜉ｹ蛹厄ｼ・LS髦ｲ豁｢・・
    ...
    // 險ｭ螳夊ｪｭ縺ｿ霎ｼ縺ｿ: 菫晏ｭ俶ｸ医∩險隱槭′縺ｪ縺代ｌ縺ｰ繝ｪ繝ｼ繧ｸ繝ｧ繝ｳ縺ｮ險隱槭ｒ繝・ヵ繧ｩ繝ｫ繝医↓
    ...
    // 繝代ャ繧ｯ繧ｫ繝ｫ繝ｼ繧ｻ繝ｫ繧貞虚逧・函謌撰ｼ・wait縺ｧ螳御ｺ・ｒ蠕・▽縺薙→縺ｧ繧ｹ繧ｯ繝ｭ繝ｼ繝ｫ菴咲ｽｮ縺ｮ豁｣縺励＞繝ｪ繧ｻ繝・ヨ繧剃ｿ晁ｨｼ・・
    await buildPackCarousel();
    ...
    // 繧ｰ繝ｭ繝ｼ繝舌Ν蜿ら・・井ｻ悶Δ繧ｸ繝･繝ｼ繝ｫ縺九ｉ蜻ｼ縺ｳ蜃ｺ縺礼畑・・
    ...
    // SVG繧ｰ繝ｩ繝・・繧ｷ繝ｧ繝ｳ螳夂ｾｩ繧呈ｳｨ蜈･
    injectTop200Gradient();

    // 蛻晏屓繧｢繧ｯ繧ｻ繧ｹ譎ゅ・髻ｳ螢ｰ豕ｨ諢上ヨ繝ｼ繧ｹ繝・
    ...
    // 繧ｿ繝門ｾｩ蟶ｰ譎ゅ↓繝・・繧ｿ繧ｭ繝｣繝・す繝･繧呈峩譁ｰ・・op200-daily.json繧貞・蜿門ｾ暦ｼ・
