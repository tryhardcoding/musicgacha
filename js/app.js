...
import './gacha.js?v=20260327d'; // ガチャモジュール（グローバル参照にopenPackを登録）
...
import { initAds, showRewardedAd, updateAdButton, refreshModalBannerAd } from './ads.js?v=20260327d';
import { icon, refreshIcons } from './icons.js';
import { sharePackResult, shareCollectionStats } from './share-sns.js?v=20260327d';
