...
import './gacha.js?v=20260329f'; // ガチャモジュール�E�グローバル参�EにopenPackを登録�E�E
...
import { initAds, showRewardedAd, updateAdButton, refreshModalBannerAd } from './ads.js?v=20260329f';
import { icon, refreshIcons } from './icons.js';
import { sharePackResult, shareCollectionStats } from './share-sns.js?v=20260329f';
